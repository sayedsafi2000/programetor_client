                ...
                <div class="lg:w-1/2 md:w-8/12 sm:w-9/12 w-full">
                    <div class="bg-white shadow rounded p-8">
                        ...
                        {box1 && (
                            <ul class="">
                                <li>
                                    <p class="text-base leading-normal text-gray-600 mt-4 lg:w-96">We are providing best online courses for you.We are trying to give you all the necessary elements for your selected course</p>
                                </li>
                            </ul>
                        )}
                    </div>
                    <div class="bg-white shadow rounded p-8 mt-8">
                        ...
                        {box2 && (
                            <ul>
                                <li>
                                    <p class="text-base leading-normal text-gray-600 mt-4 lg:w-96">If you want to choose Pro plan the you can use all payments. You can pay from Paypal, Payoneer, Master Card, Debit Card.</p>
                                </li>
                            </ul>
                        )}
                    </div>
                    <div class="bg-white shadow rounded p-8 mt-8">
                        ...
                        {box3 && (
                            <ul>
                                <li>
                                    <p class="text-base leading-normal text-gray-600 mt-4 lg:w-96">We can give you all te safety about your data and course.Your payment process etc.</p>
                                </li>
                            </ul>
                        )}
                    </div>
                    <div class="bg-white shadow rounded p-8 mt-8">
                        ...
                        {box4 && (
                            <ul>
                                <li>
                                    <p class="text-base leading-normal text-gray-600 mt-4 lg:w-96">Don't worry about your account.If you forget your password just click forget your password? We will reset your password imedieatly.</p>
                                </li>
                            </ul>
                        )}
                    </div>
